...
namespace CondoHub.Controllers
{
    ...
    public class ContractsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, ContractType? type, string tab = "contracts")
        {
            ...
            if (!string.IsNullOrEmpty(searchString))
            {
                query = query.Where(c =>
                    ...
                    (c.Property != null && c.Property.Contains(searchString))
                );
            }
            ...
            // montar mapa de imóveis referenciados por contratos para exibição nos cards
        ...
        {
            // carregar lista de imóveis para o select
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (contract == null)
                return NotFound();
            // carregar lista de imóveis para o select (quando aplicável)
